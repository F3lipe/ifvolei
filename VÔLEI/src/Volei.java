...
public interface Volei {
	...
	public Tecnico RemoverTecnico(Tecnico tecnico) throws IdInexistenteException, EntidadeNaoEncontradaException;

	public Time RemoverTime(Time time) throws IdInexistenteException, EntidadeNaoEncontradaException;

	public Atleta RemoverAtleta(Atleta atleta) throws IdInexistenteException, EntidadeNaoEncontradaException;
